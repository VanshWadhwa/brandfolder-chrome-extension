...
const highlightColor = "rgb(213, 0,0)";
...
const template = `
  ...
  <button id="chromeExtensionMarker">
...
class chromeExtensionMarker extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot
      .getElementById("chromeExtensionMarker")
  ...
  highlightSelection() {
    ...
    window.open("http://localhost:3000/editor?title=" + userSelection);
